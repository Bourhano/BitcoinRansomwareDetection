...
# file source: https://archive.ics.uci.edu/ml/machine-learning-databases/00526/data.zip
...
X_train, X_test, Y_train, Y_test = train_test_split(
    X_public, Y_public, random_state=42, test_size=0.3, stratify=Y_public, shuffle=True
)
...
private_set.to_csv(os.path.join(private_path, "private.csv.gzip"), index=False, compression="gzip")
public_train.to_csv(os.path.join(public_path, "train.csv.gzip"), index=False, compression="gzip")
public_test.to_csv(os.path.join(public_path, "test.csv.gzip"), index=False, compression="gzip")
